...
namespace Assets.AssetsStore.StarterAssets.Editor
{
    public partial class StarterAssetsDeployMenu : ScriptableObject
    {
        ...
        {
            var firstPersonControllers = FindObjectsOfType<FirstPersonController.Scripts.FirstPersonController>();
            ...
            if (player == null)
            {
                if (TryLocatePrefab(PlayerCapsulePrefabName, null, new []{typeof(FirstPersonController.Scripts.FirstPersonController)}, out GameObject prefab, out string _))
                {
        ...
        {
            if (TryLocatePrefab(PlayerCapsulePrefabName, null, new[] { typeof(FirstPersonController.Scripts.FirstPersonController), typeof(StarterAssetsInputs) }, out GameObject _, out string prefabPath))
            {
